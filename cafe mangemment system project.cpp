...
#include<iomanip>
using namespace std;
/*This class is responible for menu ordering, bill generation
	...
	void bill()
    {
		...
		while (1)
		{
			...
			if (choice == 0)
			{
				...
				sales<<"_______________________________________________"<<endl;
				sales<<"\n";
				sales.close();
				system("CLS");
				cout<<"_______________________________________________"<<endl;
...
//This is the base class of the inheritence
class Employee
{
	protected:
		string fname,sname;
...
class Waiter:public Employee
{
	...
	public:
		...
		{   
			...
			Waiters<<"_______________________________________________"<<endl;
			Waiters<<"\n";  
			Waiters.close();
			_getch();
			system("CLS");
...
class Receptionist:public Employee
{
	...
	public:
		...
		{   
			...
			Receptionists<<"_______________________________________________"<<endl;
			Receptionists<<"\n";  
			Receptionists.close();
			_getch();
			system("CLS");
